<header id="header" class="header-show-hide-on-scroll menu-align-right">
    ...
    <div class="header-inner tt-wrap"> <!-- add/remove class "tt-wrap" to enable/disable element boxed layout (class "tt-boxed" is required in <body> tag! ) -->
        ...
        ================ -->
        <div id="logo">
            <a href="index.html" class="logo-dark"><img src="<?php echo $BASE_URL;?>/images/logo-dark.png" alt="logo"></a>
            <a href="index.html" class="logo-light"><img src="<?php echo $BASE_URL;?>/images/logo-light.png" alt="logo"></a>

            <!-- for small screens -->
            <a href="index.html" class="logo-dark-m"><img src="<?php echo $BASE_URL;?>/images/logo-dark-m.png" alt="logo"></a>
            <a href="index.html" class="logo-light-m"><img src="<?php echo $BASE_URL;?>/images/logo-light-m.png" alt="logo"></a>
        </div>
        <!-- End logo -->
                ...
                <ul>
                    ...
                    * Use class "tt-dropdown-dark" to enable dropdown dark style.
                    ...
                    <li class="tt-dropdown-wrap tt-dropdown-master tt-dropdown-dark tt-dropdown-right tt-tools-lang">
                        <a href="#0"><img src="<?php echo $BASE_URL;?>/images/gb.png" alt="English"> EN</a>
                        <ul class="tt-dropdown">
                            <li><a href="" title="English"><img src="<?php echo $BASE_URL;?>/images/gb.png" alt="English"> EN</a></li>
                            <li><a href="" title="French"><img src="<?php echo $BASE_URL;?>/images/fr.png" alt="French"> FR</a></li>
                            <li><a href="" title="Deutsch"><img src="<?php echo $BASE_URL;?>/images/de.png" alt="Deutsch"> DE</a></li>
                        </ul> <!-- /.tt-dropdown -->
                    </li>
                    <!-- End tt-dropdown -->
